...
define('text!tpl/home_template.html',[],function () { return '<h2>Welcome to Picture Trivia</h2>\n<a href="login/back" data-transition="slide-in">Back</a>\n';});
...
(function() {
  ...
  define('views/home_view',["backbone", "text!tpl/home_template.html"], function(Backbone, template) {
    var HomeView;

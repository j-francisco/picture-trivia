...
(function() {
  ...
  define('views/base_view',["backbone"], function(Backbone) {
    var BaseView;
...
(function() {
  ...
  define('routers/router',["backbone", "views/base_header_view", "views/login_view", "views/home_view", "views/categories_view", "views/get_ready_view", "views/game_view"], function(Backbone, BaseHeaderView, LoginView, HomeView, CategoriesView, GetReadyView, GameView) {
    var AppRouter;

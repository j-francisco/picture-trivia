...
(function() {
  ...
  define('views/home_view',["backbone", "views/base_view", "text!tpl/home.html", "models/answer", "collections/answer_collection", "models/question"], function(Backbone, BaseView, template, Answer, AnswerCollection, Question) {
    var HomeView;
...
(function() {
  ...
  define('views/question_view',["backbone", "views/base_view", "text!tpl/question.html", "models/answer", "collections/answer_collection", "models/question"], function(Backbone, BaseView, template, Answer, AnswerCollection, Question) {
    var QuestionView;
...
(function() {
  ...
  define('routers/router',["backbone", "views/base_header_view", "views/login_view", "views/home_view", "views/question_view"], function(Backbone, BaseHeaderView, LoginView, HomeView, QuestionView) {
    var AppRouter;

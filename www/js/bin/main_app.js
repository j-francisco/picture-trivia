...
(function() {
  ...
  define('views/login_view',["backbone", "text!tpl/login_template.html"], function(Backbone, template) {
    var LoginView;
...
(function() {
  ...
  define('views/home_view',["backbone", "text!tpl/home_template.html", "models/answer", "collections/answer_collection", "models/question"], function(Backbone, template, Answer, AnswerCollection, Question) {
    var HomeView;
...
(function() {
  ...
  define('routers/router',["backbone", "views/login_view", "views/home_view"], function(Backbone, LoginView, HomeView) {
    var AppRouter;

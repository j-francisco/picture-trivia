...
define('text!tpl/home.html',[],function () { return '<a href="game">\n\t<div class="play-now-btn pt-btn pt-bg-color-blue">\n\t\t<span class="play-lbl">Play Now</span>\n\t</div>\n</a>';});
      ...
      QuestionView.prototype.render = function() {
        ...
        this.model.get("answers").each((function(_this) {
          return function(answer) {
            ...
            console.log("sub views count:");
            console.log(_this.subViews);
...
(function() {
  ...
  define('views/game_view',["backbone", "views/base_view", "text!tpl/game.html", "models/answer", "collections/answer_collection", "models/question", "views/question_view"], function(Backbone, BaseView, template, Answer, AnswerCollection, Question, QuestionView) {
    var GameView;
...
(function() {
  ...
  define('routers/router',["backbone", "views/base_header_view", "views/login_view", "views/home_view", "views/game_view"], function(Backbone, BaseHeaderView, LoginView, HomeView, GameView) {
    var AppRouter;

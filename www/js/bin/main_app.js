...
define('text!tpl/display_values.html',[],function () { return '<script id="ptMessages" type="application/json">\n[\n{ "key": "world", "displayVal": "World" }\n]\n</script>';});
...
(function() {
  ...
  define('views/base_view',["backbone", "text!tpl/display_values.html"], function(Backbone, displayValuesTemplate) {
    var BaseView;
...
define('text!tpl/default_header.html',[],function () { return '<header class="bar bar-nav">\n  <a href="javascript:void(0);" class="icon icon-left-nav pull-left go-back"></a>\n  <h1 class="title pt-primary-color-0">Picture Trivia</h1>\n</header>';});
...
(function() {
  ...
  define('views/base_header_view',["backbone", "views/base_view", "text!tpl/default_header.html"], function(Backbone, BaseView, template) {
    var BaseHeaderView;
...
define('text!tpl/login.html',[],function () { return '<form>\n  <div class="input-group">\n    <div class="input-row">\n      <label>Email</label>\n      <input id="loginEmail" type="email" placeholder="Enter Email Address">\n    </div>\n    <!-- <div class="input-row">\n      <label>Password</label>\n      <input id="loginPassword" type="password" placeholder="Enter Password">\n    </div> -->\n  </div>\n  <a class="button button-block login-btn" href="javascript:void(0);" data-skip="true">Login</a>\n</form>';});
...
(function() {
  ...
  define('views/login_view',["backbone", "views/base_view", "text!tpl/login.html"], function(Backbone, BaseView, template) {
    var LoginView;
...
define('text!tpl/home.html',[],function () { return '<div class="home-btns-container">\n\t<a href="categories/forward">\n\t\t<div class="block-btn block-btn-1 pt-btn pt-complement-bgcolor-1">\n\t\t\t<span class="block-btn-lbl">Play Now</span>\n\t\t</div>\n\t</a>\n\t<a href="#">\n\t\t<div class="block-btn block-btn-1 pt-btn pt-complement-bgcolor-1">\n\t\t\t<span class="block-btn-lbl">My Stats</span>\n\t\t</div>\n\t</a>\n</div>';});


define('text!tpl/game.html',[],function () { return '<div class="question-container">\n\n</div>';});


define('text!tpl/game_loading.html',[],function () { return 'Loading...';});
...
(function() {
  ...
  define('models/answer',["backbone"], function(Backbone) {
    var Answer;
...
(function() {
  ...
  define('collections/answer_collection',["backbone", "models/answer"], function(Backbone, Answer) {
...
(function() {
  ...
  define('models/question',["backbone"], function(Backbone) {
    var Question;
...
(function() {
  ...
  define('models/game',["backbone"], function(Backbone) {
    var Game;
...
define('text!tpl/question.html',[],function () { return '<div class="question-picture-container">\n\t<div class="question pt-complement-color-0"><%- question.get("text") %></div>\n\t<img class="question-picture" src="<%- question.get(\'img_src\') %>"></img>\n\n\t<!-- <canvas class="question-picture-canvas" width="800" height="600"> -->\n</div>\n\n<div class="answer-container">\n\t\n</div>';});


define('text!tpl/answer.html',[],function () { return '<span><%- answer.text %></span>';});
...
(function() {
  ...
  define('views/answer_view',["backbone", "views/base_view", "text!tpl/answer.html", "models/Answer"], function(Backbone, BaseView, template, Answer) {
    var AnswerView;
...
(function() {
  ...
  define('views/question_view',["backbone", "views/base_view", "text!tpl/question.html", "models/answer", "collections/answer_collection", "models/question", "views/answer_view"], function(Backbone, BaseView, template, Answer, AnswerCollection, Question, AnswerView) {
    var QuestionView;
...
(function() {
  ...
  define('views/game_view',["backbone", "views/base_view", "text!tpl/game.html", "text!tpl/game_loading.html", "models/answer", "collections/answer_collection", "models/question", "models/game", "views/question_view"], function(Backbone, BaseView, template, loadingTemplate, Answer, AnswerCollection, Question, Game, QuestionView) {
    var GameView;
...
(function() {
  ...
  define('views/home_view',["backbone", "views/base_view", "text!tpl/home.html", "views/game_view"], function(Backbone, BaseView, template, GameView) {
    var HomeView;
...
define('text!tpl/categories.html',[],function () { return '<div class="categories-btns-container">\n\t<div>\n\t\t<a href="get_ready/world/forward">\n\t\t\t<span class="block-btn block-btn-2 pt-btn pt-complement-bgcolor-1">\n\t\t\t\t<span class="block-btn-lbl"> World</span>\n\t\t\t</span>\n\t\t</a>\n\t\t<a href="get_ready/north_america/forward">\n\t\t\t<span class="block-btn block-btn-2 pt-btn pt-complement-bgcolor-1">\n\t\t\t\t<span class="block-btn-lbl"> North America</span>\n\t\t\t</span>\n\t\t</a>\n\t</div>\n\t<div>\n\t\t<a href="get_ready/south_america/forward">\n\t\t\t<span class="block-btn block-btn-2 pt-btn pt-complement-bgcolor-1">\n\t\t\t\t<span class="block-btn-lbl"> South America</span>\n\t\t\t</span>\n\t\t</a>\n\t\t<a href="get_ready/europe/forward">\n\t\t\t<span class="block-btn block-btn-2 pt-btn pt-complement-bgcolor-1">\n\t\t\t\t<span class="block-btn-lbl"> Europe</span>\n\t\t\t</span>\n\t\t</a>\n\t</div>\n\t<div>\n\t\t<a href="get_ready/africa/forward">\n\t\t\t<span class="block-btn block-btn-2 pt-btn pt-complement-bgcolor-1">\n\t\t\t\t<span class="block-btn-lbl"> Africa</span>\n\t\t\t</span>\n\t\t</a>\n\t\t<a href="get_ready/asia/forward">\n\t\t\t<span class="block-btn block-btn-2 pt-btn pt-complement-bgcolor-1">\n\t\t\t\t<span class="block-btn-lbl"> Asia</span>\n\t\t\t</span>\n\t\t</a>\n\t</div>\n</div>';});
...
(function() {
  ...
  define('views/categories_view',["backbone", "views/base_view", "text!tpl/categories.html", "views/game_view"], function(Backbone, BaseView, template, GameView) {
    var CategoriesView;
...
define('text!tpl/get_ready.html',[],function () { return '<div class="get-ready-img question-picture-container">\n\t<img class="question-picture" src="<%- img %>"></img>\n</div>\n\n<div class="answer-container">\n\t<a href="game/<%-categoryName%>/forward">\n\t\t<button class="btn btn-block btn-outlined pt-complement-bgcolor-1">Start</button>\n\t</a>\n</div>';});
...
(function() {
  ...
  define('views/get_ready_view',["backbone", "views/base_view", "text!tpl/get_ready.html", "views/game_view"], function(Backbone, BaseView, template, GameView) {
    var GetReadyView;
...
define('text!tpl/final_score.html',[],function () { return '<div class="final-score">\n\t<div class="header-label">\n\t\t<span class="category-name"><%- this.getDisplayValue(game.category_name) %></span> - Final Score\n\t</div>\n\n\t<div class="sub-label">\n\t\t2 of 3 Correct\n\t</div>\n\n\t<div class="sub-label">\n\t\tTime: 0:22\n\t</div>\n\n\t<div class="links-section">\n\t\t<a href="/categories/back">Play Again</a>\n\t</div>\n</div>';});


define('text!tpl/final_score_loading.html',[],function () { return '<div class="final-score">\n\t<div class="header-label">\n\t\tLoading Final Score...\n\t</div>\n\t<div>\n\t\t<i class="fa fa-cog fa-spin"></i>\n\t</div>\n</div>';});
...
(function() {
  ...
  define('views/final_score_view',["backbone", "views/base_view", "text!tpl/final_score.html", "text!tpl/final_score_loading.html", "models/game"], function(Backbone, BaseView, template, loadingTemplate, Game) {
    var FinalScoreView;
...
(function() {
  ...
  define('routers/router',["backbone", "views/base_header_view", "views/login_view", "views/home_view", "views/categories_view", "views/get_ready_view", "views/game_view", "views/final_score_view"], function(Backbone, BaseHeaderView, LoginView, HomeView, CategoriesView, GetReadyView, GameView, FinalScoreView) {
    var AppRouter;
